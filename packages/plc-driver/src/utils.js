...
function parseAddr(addr) {
    ...
    if (!byteMatch)
        throw new Error(`无效地址: ${addr} (支持 VW100, V200.0, DBW4, DB2.DBW4, DB2.DBX0.0)`);
...
function validateAddr(addr, dataType) {
