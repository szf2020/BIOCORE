...
class FeedAdvisor {
     ...
     */
    recommend(params) {
        const { currentOD, currentGlucose, targetMu, muMax, Ks, Yxs, currentFeedRate, feedConcentration, liquidVolume, } = params;
        // Validate inputs
        if (currentOD <= 0) {
            return {
                suggestedRate: 0,
        ...
        const targetFeedRate = (targetMu / Yxs) * biomassConcentration * liquidVolume / feedConcentration;
...
exports.FeedAdvisor = FeedAdvisor;
//# sourceMappingURL=feed-advisor.js.map