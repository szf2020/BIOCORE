                    ...
                    {channels.map(c => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-xs text-muted-foreground ml-auto">{c.sensorType}</span>
                        </label>
                      );
                    })}
                  </div>
