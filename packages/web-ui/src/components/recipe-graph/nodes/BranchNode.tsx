  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="text-sm font-semibold text-amber-200">IF / ELSE</div>
      </div>
      <div className="mt-1 pt-1 border-t border-amber-700/40 text-sm font-mono text-amber-100 truncate">
        {expr}
      </div>
      {d.valid === false && (
